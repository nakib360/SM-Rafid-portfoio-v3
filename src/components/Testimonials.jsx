...
const testimonials = [
  ...
  {
    content: "The thumbnail designs Rafid produced for our channel increased our CTR by 40% in the first month. Incredible attention to detail.",
    author: "Sarah Chen",
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-12 md:mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-brand-border shadow-sm mb-8">
            ...
            <span className="text-sm font-bold text-brand-text">Testimonials</span>
          </div>
